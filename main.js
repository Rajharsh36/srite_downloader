...
const theme_func=()=>{
    ...
    if (theme=='dark'){
        ...
        body_ele.style.background="rgb(201, 138, 245)"
        html_ele.style.background="rgb(201, 138, 245)"
        ele.style.background="rgb(201, 138, 245)"
        ele.style.borderColor="rgb(201, 138, 245)"
        theme='default'
